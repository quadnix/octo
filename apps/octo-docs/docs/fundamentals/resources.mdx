...
Octo instead, as you already know, uses Models for encapsulation, which abstract these raw resources.
...
We also revisited how models create resources, and resources created infrastructure using Actions.
