...
**Octo is a cloud-agnostic, general purpose, cloud infrastructure modeling and management tool.**<br />
This simply means Octo can help you design, implement, and maintain infrastructure for your application
in the cloud of your choice, such as AWS or GCP, without you having to learn the big underlying networking concepts.
...
such as Models, Modules, and Resources. It is cloud-agnostic, meaning, the definition of Octo components
...
**Why choose Octo?**<br />
You might be familiar with one or more of the already available, industry standard Infrastructure as Code (IaC) tools,
such as, Terraform, AWS CDK, Pulumi, and others.

While these are amazing, they often get overly complicated, especially for new developers,
...
Here is how it works - you write or import modules, which generates models,
...
## Benefits
* **Power of Models**: Octo excels as a general-purpose cloud infrastructure modeling tool,
...
* **Templates**: With help of community driven, pre-tested templates, it is possible to customize and bootstrap
your infrastructure setup in a matter of minutes.
...
* **Beautiful HTML Reports**: After each run, Octo generates an HTML report that
