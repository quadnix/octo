...
export function getKindSlug(declaration: JSONOutput.DeclarationReflection): string {
...
export function getPackageSlug(pkgConfig: ResolvedPackageConfig, importPath: string, isSinglePackage: boolean): string {
