...
@Factory<UpdateSourcePathsInS3WebsiteAction>(UpdateSourcePathsInS3WebsiteAction)
export class UpdateSourcePathsInS3WebsiteActionFactory {
  static async create(): Promise<UpdateSourcePathsInS3WebsiteAction> {
    return new UpdateSourcePathsInS3WebsiteAction();
  }
}
