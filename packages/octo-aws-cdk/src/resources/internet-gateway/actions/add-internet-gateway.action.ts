...
@Factory<AddInternetGatewayAction>(AddInternetGatewayAction)
export class AddInternetGatewayActionFactory {
  static async create(): Promise<AddInternetGatewayAction> {
    return new AddInternetGatewayAction();
  }
}
