...
export class UpdateDirectoriesS3StorageModelAction extends AAction {
  readonly ACTION_NAME: string = 'UpdateDirectoriesS3StorageModelAction';
...
@Factory<UpdateDirectoriesS3StorageModelAction>(UpdateDirectoriesS3StorageModelAction)
export class UpdateDirectoriesS3StorageModelActionFactory {
  static async create(): Promise<UpdateDirectoriesS3StorageModelAction> {
    return new UpdateDirectoriesS3StorageModelAction();
  }
}
