    ...
    while (processed < diffs.length) {
      ...
      for (const diff of diffsInSameLevel) {
        ...
        for (const a of diff.actions as IUnknownModelAction[]) {
          ...
          const inputs: ActionInputs = { inputs: {}, models: {}, overlays: {}, resources: {} };
          ...
          const allKeys = [...inputKeys, ...nodeKeys];
          ...
          for (const k of allKeys) {
            ...
            if (k.startsWith(`${moduleId}.input`)) {
              inputs.inputs[k.split('.')[2]] = inputValue;
            } else if (k.startsWith(`${moduleId}.model`)) {
              inputs.models[k.split('.')[2]] = inputValue as UnknownModel;
            } else if (k.startsWith(`${moduleId}.overlay`)) {
              inputs.overlays[k.split('.')[2]] = inputValue as UnknownOverlay;
            } else if (k.startsWith(`${moduleId}.resource`)) {
              inputs.resources[k.split('.')[2]] = inputValue as UnknownResource;
            }
          }
